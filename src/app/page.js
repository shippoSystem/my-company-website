...
// Import images - โดยปกติ Next.js จะมองที่ root path คือ /public โดยตรง
/* import banner1 from './images/bannerS1.gif';
import banner2 from './images/bannerS3.gif';
import banner3 from './images/bannerS2.gif';
import serviceIcon1 from './images/service-icon-01.png';
import serviceIcon2 from './images/service-icon-02.png';
import serviceIcon3 from './images/service-icon-03.png';
import saleBanner from './images/sale_banner-removebg.png';
    ...
    <div className="min-h-screen bg-gray-50">
          ...
          >
            ...
            >
              ...
              <motion.div
                ...
                variants={itemVariants}
              >
                <Link href="/services/die-casting" className="absolute inset-0 z-30">
                ...
                <Image alt='banner1'
                  ...
                  height={500}
                  unoptimized
                  src={getPublicPath('/images/bannerS1.gif')}
              ...
              <motion.div
                ...
                variants={itemVariants}
              >
                <Link href="/services/arcana-info" className="absolute inset-0 z-30">
                ...
                <Image alt='banner2'
                  ...
                  width={1200}
                  height={500}
                  src={getPublicPath('/images/bannerS3.gif')}
                  className="w-full object-cover object-center transition-transform duration-300 group-hover:scale-105"
                />
                <div className="absolute bottom-0 left-0 p-6 z-20 text-white">
              ...
              <motion.div
                ...
                variants={itemVariants}
              >
                <Link href="/services/eco-cylinder" className="absolute inset-0 z-30">
                ...
                <Image alt='banner3'
                  ...
                  width={1200}
                  height={500}
                  src={getPublicPath('/images/bannerS2.gif')}
                  className="w-full object-cover object-center transition-transform duration-300 group-hover:scale-105"
                />
                <div className="absolute bottom-0 left-0 p-6 z-20 text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-6 lg:px-6">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          {/* Service Card 1 */}
          <motion.div
            className="bg-shippo-soft rounded-lg shadow-md overflow-hidden"
            initial="offscreen"
          ...
          >
            <div className="p-6">
              ...
              />
              <h3 className="text-lg font-bold text-gray-900 mt-2">{t('sec2b1h1')}</h3>
          ...
          >
            <div className="p-6">
              ...
              />
              <h3 className="text-lg font-bold text-gray-900 mt-2">{t('sec2b1h2')}</h3>
          ...
          >
            <div className="p-6">
              ...
              />
              <h3 className="text-lg font-bold text-gray-900 mt-2">{t('sec2b1h3')}</h3>
        ...
        <div className="flex  items-center justify-center mt-12 gap-1 mb-12">
          ...
          >
            <Image alt='sale photo'
              width={500}
              height={700}
              src={getPublicPath("/images/sale_banner-removebg.png")}
              className="max-h-100"
            />
          </motion.div>
        </div>
      </div>
      <div className='bg-shippo-soft w-full p-12'>
        <motion.div
          initial="hidden"
          whileInView="visible"
          ...
          >
            <div className="p-6 flex items-center justify-center">
              <Image alt='emailicon'
                width={1200}
                height={500}
                src={getPublicPath("/images/email.png")}
          ...
          >
            <div className="p-6 flex items-center justify-center">
              <Image alt='phone icon'
                width={1200}
                height={500}
                src={getPublicPath("/images/phone.png")}
                className="mr-4 h-20 w-20"
              />
