...
// import รูปภาพที่ใช้ในสไลด์
/* import slide1Image from '@/app/images/SAMTWEBSITE1.gif';
import slide2Image from '@/app/images/SAMTWEBSITE2.gif';
import slide3Image from '@/app/images/SAMTWEBSITE3.png'; */
...
const AdvancedImageSlider = () => {
    ...
    // แก้ไขอาร์เรย์ slides ให้ใช้ getPublicPath
    const slides = [
        {
            id: 1,
            image: getPublicPath('/images/SAMTWEBSITE1.gif'),
            title: t('slogan'),
            description: '',
        ...
        {
            id: 2,
            image: getPublicPath('/images/SAMTWEBSITE2.gif'),
            title: t('deadStock'),
        ...
        {
            id: 3,
            image: getPublicPath('/images/SAMTWEBSITE3.png'),
            title: t('hero_h3'),
